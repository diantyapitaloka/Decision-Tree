...
- The classification follows a "greedy" approach, meaning it makes the best possible binary choice at each junction without looking back. Your flower’s journey is a series of "True/False" answers that narrow down the identity from the entire population to a single species.
